    ...
    <main className="page-container home-page">
      <header className="home-header">
        <div className="home-brand">
          <img src="/logo-DhQCR-93.png" alt="Lanza Imóveis" className="home-logo" />
      ...
      <section className="home-hero">
        <div className="hero-content">
          <span className="hero-badge">Sistema de Fichas</span>
          <h1>Sistema de Inteligência Imobiliária</h1>
          <p>Preencha os formulários abaixo e gere seus documentos de cadastro com facilidade.</p>
        </div>
      </section>

      <section className="home-cards">
        <Link href="/ficha/residencial" className="home-card">
        ...
        <Link href="/ficha/comercial" className="home-card">
          <div className="card-icon">🏢</div>
        ...
        <Link href="/ficha/geral" className="home-card">
